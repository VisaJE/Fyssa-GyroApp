...
DECLARE_GROUP(FYSSA_PATH_POSARRAY_)
DECLARE_GROUP(FYSSA_PATH_1)
DECLARE_GROUP(FYSSA_PATH_2)
DECLARE_GROUP(FYSSA_PATH_3)
DECLARE_GROUP(FYSSA_PATH_4)
DECLARE_GROUP(FYSSA_PATH_5)
DECLARE_GROUP(FYSSA_PATH_6)
DECLARE_GROUP(FYSSA_PATH_7)
DECLARE_GROUP(FYSSA_PATH_8)
...
COMMON_TIMEISO8601 = CommonValueIds_e::TIMEISO8601,
    ...
    FYSSA_GYRO_TOPY,
    FYSSA_GYRO_TOPZ,
    FYSSA_PATH_POSARRAY_X,
    FYSSA_PATH_POSARRAY_Y,
    FYSSA_PATH_POSARRAY_Z,
...
extern const DescriptorGroup_t s_possibleSbemGroups[86];
...
extern const SbemResID2GrpIdMapping s_sbemResID2GrpIdMap[75];
